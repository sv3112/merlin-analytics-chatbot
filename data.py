...
This script processes the website content and saves it as embeddings
Using simple pickle files instead of ChromaDB to avoid locking issues
"""
...
def create_vector_database():
    ...
    # Initialize the embedding model (runs locally on your M1)
    ...
    print("\nYou can now run the chatbot backend!")
